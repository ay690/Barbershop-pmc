    ...
    <section id="contact" className="py-20 bg-white dark:bg-gray-900">
      <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <h4 className="text-gold font-medium mb-2">CONTACT US</h4>
            <h2 className="text-3xl md:text-4xl font-playfair font-bold mb-6">
              Get In Touch
            </h2>
            <p className="text-gray-600 dark:text-gray-400 mb-8">
              Have questions or need more information? Reach out to us directly,
              and our team will get back to you as soon as possible.
            </p>

            <div className="space-y-6 mb-8">
              <div className="flex items-start">
                <div className="text-gold text-xl mr-4">
                  <svg
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gold text-white flex items-center justify-center hover:bg-opacity-90 transition"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
          ...
          <div>
            {submitted ? (
              <div className="bg-lightSecondary dark:bg-black/15  p-8 rounded-lg shadow-lg text-center py-8">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <form
                id="contact-form"
                className="bg-lightSecondary dark:bg-black/15  p-8 rounded-lg shadow-lg"
              ...
              >
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-3 bg-gold text-white font-medium rounded hover:!bg-[#b38600] transition"
                >
                  Send Message
                </button>
              </form>
